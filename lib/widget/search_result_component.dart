...
class SearchResultComponent extends StatefulWidget {
  ...
  const SearchResultComponent({super.key, required this.link, required this.text, required this.linkToGo, required this.description});
      ...
      children: [
        ...
        Padding(
          ...
          child: InkWell(
            ...
            onTap: ()async{
              if(
              await canLaunchUrl(widget.linkToGo as Uri)){
